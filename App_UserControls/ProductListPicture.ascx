                    ...
                    <div class="col-md-12">
                        <div class="product-list-image">
                            <a href="<%# DataBinder.Eval(Container.DataItem, "web_items_url") %>" title="<%# DataBinder.Eval(Container.DataItem, "nazev") %>">
                                ...
                                <span class='badge mod-action <%# (ZASutility.MyUtility.SafeEvalNumeric(Container.DataItem, "ref_cena_s_dph")==0 ? 0 : Math.Ceiling(100 * (ZASutility.MyUtility.SafeEvalNumeric(Container.DataItem, "ref_cena_s_dph")-ZASutility.MyUtility.SafeEvalNumeric(Container.DataItem, "web_items_cena_s_dph")) / ZASutility.MyUtility.SafeEvalNumeric(Container.DataItem, "ref_cena_s_dph")))<1 ? "hidden" : " " %>'>Sleva
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="productRight product-list-right">
                            <div class="priceInfo product-list-price-info">
                                ...
                                <asp:PlaceHolder runat="server" Visible='<%# ZASutility.MyUtility.SafeEvalNumeric(Container.DataItem, "ref_cena_s_dph")!=0 && ZASutility.MyUtility.SafeEvalNumeric(Container.DataItem, "web_items_cena_s_dph")!=ZASutility.MyUtility.SafeEvalNumeric(Container.DataItem, "ref_cena_s_dph") %>'>
